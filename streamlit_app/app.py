...
# The column-mapping selectboxes on the Upload screen are only instantiated
# while screen == "upload". Leaving their widget state behind after
# navigating elsewhere is what caused navigation to silently break after
# uploading a file — clear it out on every other screen so it can't linger.
if st.session_state.screen != "upload":
    for _k in [k for k in st.session_state.keys() if k.startswith("map_")]:
