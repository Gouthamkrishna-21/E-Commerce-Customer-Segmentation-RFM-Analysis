...
if st.session_state.screen == "landing":
    st.markdown(
        ...
        "<h1>Transform Raw E-Commerce Data into Customer Intelligence</h1>"
        "<div class='sub'>Upload a transaction file and InsightCart cleans it, scores every "
        "customer with RFM (Recency, Frequency, Monetary) analysis, and turns it into a "
        "segmented dashboard with clear business recommendations — no spreadsheets required.</div>"
        "</div>",
